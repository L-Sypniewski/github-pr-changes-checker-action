...
public static class WaitForDebugger
{
    ...
    /// <param name="currentEnvironment">Current environment, e.g. Development or Production. This method waits for
    /// the debugger only in Development environment.</param>
    ...
    /// <param name="optionalCondition">Additional condition (besides environment being Development) that has
    /// to be met in order to wait for debugger to be attached.</param>
